...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm">
        <div class="container">
            ...
            <a href="/admin/dashboard" class="btn btn-outline-light btn-sm"><i class="bi bi-arrow-left"></i> Kembali</a>
        </div>
    </nav>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 mb-3 mb-md-0">
                    ...
                    <select name="status_pendaftaran" id="status_pendaftaran" class="form-select">
                        <option value="<?= PendaftaranModel::STATUS_PENDING ?>" <?= $santri['status_pendaftaran'] === PendaftaranModel::STATUS_PENDING ? 'selected' : '' ?>>
                                ...
                                <tr>
                                    ...
                                    <td>: 
                                        <span class="badge bg-dark">
                                            <?= str_replace('_', ' ', $santri['status_pendaftaran']) ?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
